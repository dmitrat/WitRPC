...
{
    [ProtoContract]
    public class ProtoRange<TValue> : ModelBase, IRange<TValue>, INotifyPropertyChanged
        where TValue : struct, IComparable<TValue>
    {
        ...
        public ProtoRange(TValue from, TValue to)
        {
            From = from;
            To = to;
        }
        ...
        {
            if (!(modelBase is ProtoRange<TValue> range))
                return false;
        ...
        {
            return new ProtoRange<TValue>(From, To);
        }
