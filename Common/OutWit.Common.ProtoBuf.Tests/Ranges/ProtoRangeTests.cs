...
{
    [TestFixture]
    public class ProtoRangeTests
    {
        [Test]
        public void ConstructorTest()
        {
            var range = new ProtoRange<int>(1, 2);
        ...
        public void IsTest()
        {
            var range1 = new ProtoRange<int>(1, 2);
            var range2 = new ProtoRange<int>(1, 2);

            Assert.That(range1.Is(range2), Is.True);

            range2 = new ProtoRange<int>(1, 3);
            Assert.That(range1.Is(range2), Is.False);

            range2 = new ProtoRange<int>(3, 2);
            Assert.That(range1.Is(range2), Is.False);
        }
        ...
        public void CloneTest()
        {
            ...
            var range2 = range1.Clone() as ProtoRange<int>;
        ...
        public void SerializationTest()
        {
            ...
            var range2 = bytes.FromProtoBytes<ProtoRange<int>>();
            Assert.That(range2, Is.Not.Null);
