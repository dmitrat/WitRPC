...
{
    [MemoryPackable]
    public partial class MemoryPackSet<TValue> : ModelBase, IReadOnlyCollection<TValue>
    {
        #region Fields
        ...
        protected MemoryPackSet()
        {
            m_inner = new List<TValue>();
        }

        public MemoryPackSet(params TValue[] values)
        {
            m_inner = new List<TValue>(values);
        }

        [MemoryPackConstructor]
        public MemoryPackSet(IEnumerable<TValue> inner)
        {
        ...
        {
            if (!(modelBase is MemoryPackSet<TValue> collection))
                return false;
        ...
        {
            return new MemoryPackSet<TValue>(Inner);
        }
