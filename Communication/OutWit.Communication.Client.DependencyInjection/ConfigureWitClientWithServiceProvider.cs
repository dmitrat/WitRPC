...
namespace OutWit.Communication.Client.DependencyInjection
{
    ...
    /// </summary>
    internal sealed class ConfigureWitClientWithServiceProvider : IConfigureWitClient
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="ConfigureWitClientWithServiceProvider"/>.
        /// </summary>
        ...
        public ConfigureWitClientWithServiceProvider(string name, Action<WitClientBuilderContext> configure)
        {
