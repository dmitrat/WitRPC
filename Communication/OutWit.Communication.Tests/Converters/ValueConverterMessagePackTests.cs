...
{
    [TestFixture]
    public class ValueConverterMessagePackTests
    {
        [TestCase(1.23f)]
        [TestCase(-3.1415f)]
        public void FloatToDoubleConversionTest(float expected)
        {
            bool succeed = new ValueConverterMessagePack().TryConvert(expected, typeof(double), out object? actual);
        ...
        {
            bool succeed = new ValueConverterMessagePack().TryConvert(expected, typeof(long), out object? actual);
        ...
        {
            bool succeed = new ValueConverterMessagePack().TryConvert(expected, typeof(DateTime), out object? actual);
        ...
        public void JsonObjectToComplexTypeConversionTest()
        {
            ...
            object? obj = expected.ToPackBytes().FromPackBytes<object>();

            bool succeed = new ValueConverterMessagePack().TryConvert(obj, typeof(ComplexType), out object? actual);
        ...
        public void Int32ArrayConversionTest()
        {
            ...
            bool succeed = new ValueConverterMessagePack().TryConvert(obj, typeof(int[]), out object? actual);
        ...
        public void Int32ListConversionTest()
        {
            ...
            bool succeed = new ValueConverterMessagePack().TryConvert(obj, typeof(List<int>), out object? actual);
        ...
        {
            bool succeed = new ValueConverterMessagePack().TryConvert(new ComplexType(), typeof(IComplexType), out object? actual);
        ...
        {
            bool succeed = new ValueConverterMessagePack().TryConvert(input, typeof(EnumType), out object? actual);
        ...
        public void StringToGuidConversionTest()
        {
            ...
            bool succeed = new ValueConverterMessagePack().TryConvert(expected.ToString(), typeof(Guid), out object? actual);
        ...
        public void RoundTripDateTimeConversionTest(string valueData)
        {
            PerformRoundTripTest(ParseTestData<DateTime>(valueData),
                assertAreEqual: (x, y) => Assert.That(
                    DateTime.SpecifyKind(x, DateTimeKind.Unspecified).ToLongTimeString(),
                    Is.EqualTo(DateTime.SpecifyKind(y, DateTimeKind.Unspecified).ToLongTimeString())));
        }
        ...
        {
            bool succeed = new ValueConverterMessagePack().TryConvert(value, typeof(string), out object? intermediate);
            bool succeed2 = new ValueConverterMessagePack().TryConvert(intermediate, typeof(T), out object? final);
