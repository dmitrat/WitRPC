...
namespace OutWit.Communication.Tests.Serialization.Json
{
    [TestFixture]
    public class RequestStrongAssemblyMatchJsonSerializationTests
    {
        [Test]
        public void SimpleRequestSerializationTest()
        {
            var serializer = new MessageSerializerJson();
            var converter = new ValueConverterJson();
