...
namespace OutWit.Communication.Tests.Interceptors
{
    ...
    public class RequestInterceptorDynamicTests
    {
        ...
        public async Task SimpleRequestsAsyncTest()
        {
            ...
            Assert.That(await serviceProxy.RequestDataAsync("text"), Is.EqualTo("text"));
            Assert.That(await serviceProxy.GenericSimpleAsync(12, "34", 5.6), Is.EqualTo(5.6));
            Assert.That((await serviceProxy.GenericComplexAsync(12, "34", new ComplexNumber<int, double>(56, 6.7))).Is(new ComplexNumber<int, double>(56, 6.7)), Is.EqualTo(true));
            Assert.That((await serviceProxy.GenericComplexArrayAsync(12, "34", new List<ComplexNumber<int, double>>
            {
                new ComplexNumber<int, double>(56, 6.7),
                new ComplexNumber<int, double>(89, 10.11),
                new ComplexNumber<int, double>(123, 14.15),
            ...
            Assert.That((await serviceProxy.GenericComplexMultiAsync(new ComplexNumber<string, string>("aa", "bb"), "34", new List<ComplexNumber<int, double>>
            {
                new ComplexNumber<int, double>(56, 6.7),
                new ComplexNumber<int, double>(89, 10.11),
                new ComplexNumber<int, double>(123, 14.15),
